...
{
	// UI-часть (DoAction, PrintOnAirInquire) — в CampaignOnSingleMassmedia.WinForms.cs.
	...
	partial class CampaignOnSingleMassmedia : Campaign
	{
		...
		// DoAction и PrintOnAirInquire переехали в CampaignOnSingleMassmedia.WinForms.cs.
