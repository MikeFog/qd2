...
{
	// UI-часть Bank: UpdateBankList — качает файл с котировками и вызывает
	// Cursor/Application.DoEvents; owner в теле не используется, но сигнатура
	// принимает IWin32Window. Дословный перенос, логика не менялась.
