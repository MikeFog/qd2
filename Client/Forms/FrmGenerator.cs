	...
	public partial class FrmGenerator : Form
	{
		...
		public void Generate()
		{
			...
			finally
			{
				...
				/*
				MessageBox.Show(
					string.Format("��������� ��������� �� {0:F2} ���.", sw.Elapsed.TotalSeconds),
					"����� ����������",
		...
		private List<PresentationObject> AddSimpleIssues()
		{
			...
			if (_template.Quantity != 0)
			{
				...
				issues.AddRange(AddIssuesFromWindows(windows, _template.Quantity, "������������ ��������� ���� ��� ���������� ���� �������� ��� ����������. ����: {0}, �������� {1}."));
			}
			else
			{
				...
				issues.AddRange(AddIssuesFromWindows(windowsPrime, _template.QuantityPrime, "������������ ��������� ���� ����� ��� ���������� ���� ��������. ����: {0}, �������� {1}."));
				issues.AddRange(AddIssuesFromWindows(windowsNonPrime, _template.QuantityNonPrime, "������������ ��������� ���� ��� ����� ��� ���������� ���� ��������. ����: {0}, �������� ��� ���������� {1}."));
			}
