...
AS
SELECT   userID, firstName, secondName, lastName, loginName, birthday, passwordHash, isActive, email, phone, userName, isAdmin, isTrafficManager, isGrantor, isBookKeeper
FROM     dbo.[User]
WHERE   (userID <> 0) AND (lastName <> 'QD')
