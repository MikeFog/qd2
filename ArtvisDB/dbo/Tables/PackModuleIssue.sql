CREATE TABLE [dbo].[PackModuleIssue] (
    ...
    [ratio]             DECIMAL (18, 10) CONSTRAINT [DF_PackModuleIssue_ratio] DEFAULT ((1)) NOT NULL,
    [positionId]        SMALLINT         NOT NULL,
    [isConfirmed]       BIT              CONSTRAINT [DF_PackModuleIssue_isConfirmed] DEFAULT (0) NOT NULL,
    [tariffPrice]       DECIMAL (18, 2)  CONSTRAINT [DF_PackModuleIssue_tariffPrice] DEFAULT ((0)) NOT NULL,
