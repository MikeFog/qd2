/*
    ДЕПЛОЙ: переводы веб-версии на язык «es» (1340 строк). docs/tasks/web-i18n.md, этап 5.
...
(N'Внести выходы рекламных роликов для времени {0} в соответствии с шаблоном?' + NCHAR(10) + N'{3} [c {1} по {2}]', N'¿Registrar las emisiones de spots para la hora {0} según la plantilla?' + NCHAR(10) + N'{3} [del {1} al {2}]'),
...
(N'Удалить выходы рекламных роликов для времени {0} в соответствии с шаблоном?' + NCHAR(10) + N'{3} [c {1} по {2}]', N'¿Eliminar las emisiones de spots publicitarios para la hora {0} según la plantilla?' + NCHAR(10) + N'{3} [del {1} al {2}]'),
